...
from utah import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, DONATION_LINK, CERT_PATH, PORT, URL, LOGGER, spamcheck
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from utah.modules import ALL_MODULES
from utah.modules.languages import tl
from utah.modules.helper_funcs.chat_status import is_user_admin
from utah.modules.helper_funcs.misc import paginate_modules
from utah.modules.helper_funcs.verifier import verify_welcome
from utah.modules.sql import languages_sql as langsql

from utah.modules.connection import connect_button
from utah.modules.languages import set_language
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("utah.modules." + module_name)
