...
import utah.modules.sql.blsticker_sql as sql
from utah import dispatcher, SUDO_USERS, LOGGER, spamcheck, OWNER_ID
from utah.modules.disable import DisableAbleCommandHandler
from utah.modules.helper_funcs.chat_status import can_delete, is_user_admin, user_not_admin, user_admin, \
		bot_can_delete, is_bot_admin
from utah.modules.helper_funcs.filters import CustomFilters
from utah.modules.helper_funcs.misc import split_message
from utah.modules.warns import warn
from utah.modules.log_channel import loggable
from utah.modules.sql import users_sql
...
def __stats__():
	return tl(OWNER_ID, "{} pemicu daftar hitam stiker, di seluruh {} obrolan.").format(sql.num_stickers_filters(),
